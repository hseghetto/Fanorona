...
void movimento_aleatorio() { //movimento p computador
	...
	if (ms) { //tenta mover
		...
		cout << x << " " << y << " random choice \n";
		cout << _x_s << " " << _y_s << " selected piece \n"; //verificar aqui
...
int main(int argc, char** argv)
{
	...
	cout << "Deseja jogar contra o computador? (1 para PC jogar primeiro, -1 para PC jogar depois, 0 para PC não jogar)" << endl;
	cin >> _pc;
